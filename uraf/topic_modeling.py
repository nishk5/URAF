...
class TopicModeling:
    ...
    def __init__(self, min_topic_size=3):
        ...
        self.topic_model = BERTopic(embedding_model=self.embedding_model, min_topic_size=min_topic_size, verbose=True)
    ...
    def extract_topics(self, responses, batch_size=32):
        ...
        return {"topics": topics, "topic_info": topic_info, "representative_docs": topic_docs}
    ...
    def update_topics(self, new_responses):
        ...
        self.topic_cache.update({"last_update": len(new_responses), "topic_info": updated_info})

        return {"updated_topics": updated_info, "new_topics": self._detect_new_topics(updated_info)}
